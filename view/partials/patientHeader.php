...
.logout-btn { background-color: rgba(255,255,255,0.2); color: white; padding: 8px 20px; border: 1px solid white; border-radius: 5px; text-decoration: none; font-size: 14px; }
    ...
    <div class="header-right">
        <div class="user-info">
            <div class="user-avatar">
                <?php echo strtoupper(substr(isset($_SESSION['patient_name']) ? $_SESSION['patient_name'] : 'P', 0, 1)); ?>
            </div>
            <span><?php echo htmlspecialchars(isset($_SESSION['patient_name']) ? $_SESSION['patient_name'] : 'Patient'); ?></span>
        </div>
        <a href="../../controllers/patientLogoutController.php" class="logout-btn">Logout</a>
    </div>
</div>